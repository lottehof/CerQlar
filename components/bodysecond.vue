<!-- <template lang="html">
  <section>
    ...
    <div class="Styled__container" v-for="(items, name) in body" :key="name">
      <h1>test</h1>
        <contentSection v-if="items.sys.contentType.sys.idd === 'contentSection'" :item="item" />
    </div>
  </section>
</template>
      ...
      <div class="style__container" >
        ...
        :class="['style__row', (items.fields.isReversed ? 'isReversed' : 'is-false'), (items.fields.isCentered ? 'isCentered' : 'is-false')]">
          ...
          <div class="style__StyledColumn" :class="items.fields.isCentered ? 'flex' : 'is-false'">
            <h2 class="style__H2">{{ items.sys.contentType.sys.id }}</h2>
            ...
            <!-- <a class="style__A"  >
               ...
               <CallToAction v-for="cTa in items"
                :cTas="items.callToAction"/>
            <a :href="item.fields.callToAction.url" class="style__A">
                <span class="style__label">{{items.fields.callToAction}}</span>
